    ...
    return NextResponse.json({
      ...
      data: {
        ...
        summary: {
          ...
          avgResponseTime: Object.values(stats).reduce((sum, stat) => sum + stat.avgTime, 0) / Object.keys(stats).length || 0,
          overallErrorRate: Object.values(stats).reduce((sum, stat) => sum + stat.errorRate, 0) / Object.keys(stats).length || 0,
        },
      },
    })
  } catch (error) {
