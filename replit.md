...
- June 29, 2025. Added CSV export functionality to share operation - users can now export successful share links in CSV format with "name,sharelink" structure, includes automatic file naming with dates and proper error handling
```
